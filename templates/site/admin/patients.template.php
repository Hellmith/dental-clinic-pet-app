                                ...
                                <tr>
                                    <td class="h-px w-auto whitespace-nowrap">
                                        <div class="px-6 py-2 flex items-center gap-x-3">
                                            <span class="text-sm w-4 text-gray-600 dark:text-gray-400"><?= $patient['id'] ?></span>
                                            <span class="font-semibold text-sm text-gray-800 dark:text-gray-200"> <?= $patient['patient_surname'] . ' ' . mb_substr($patient['patient_name'], 0, 1) . '. ' . mb_substr($patient['patient_patronymic'], 0, 1) . '.' ?></span>
                                        </div>
                                    </td>
                                    <td class="h-px w-auto whitespace-nowrap">
                                        <div class="px-6 py-2 flex items-center gap-x-3">
